...
$(document).ready(function () {
    ...
    $sizeA.click(function () {
        var t = $(this), size = $sizeA, qtt = $('#Quantity'), atc = $('.btnAddToCart'), attrs = {};
    ...
    $colorA.click(function () {
        var t = $(this), size = $('#product-select-watch .size.req .swatch-element'), qtt = $('#Quantity'), atc = $('.btnAddToCart'), attrs = {}, $colorA = $('#product-select-watch .color.req .swatch-element'),
            $colorAt = $('#product-select-watch .color.req .swatch-element.active');
        if (!t.hasClass('active')) {
